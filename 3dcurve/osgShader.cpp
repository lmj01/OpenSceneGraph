...
osg::Node* createBezierScene(osg::Camera* camera)
{
    ...
    program->addShader(osg::Shader::readShaderFile(osg::Shader::VERTEX, "../lmjdata/shaders/bezier.vert"));
    program->addShader(osg::Shader::readShaderFile(osg::Shader::GEOMETRY, "../lmjdata/shaders/bezier.geom"));
    program->addShader(osg::Shader::readShaderFile(osg::Shader::FRAGMENT, "../lmjdata/shaders/bezier.frag"));
    ...
    // add uniforms
    osg::Uniform* modelViewProjectionMatrix = new osg::Uniform("ModelViewProjectionMatrix",osg::Matrixf());
    ...
    osg::Uniform* viewportVector = new osg::Uniform("Viewport", osg::Vec2());
    viewportVector->setUpdateCallback(new ViewportCallback(camera));
    state->addUniform(viewportVector);

    osg::Uniform* cameraEye = new osg::Uniform("CameraEye", osg::Vec4());
...
osg::Node* createPolylineScene(osg::Camera* camera)
{
    ...
    program->addShader(osg::Shader::readShaderFile(osg::Shader::VERTEX, "../lmjdata/shaders/polyline.vert"));
    program->addShader(osg::Shader::readShaderFile(osg::Shader::GEOMETRY, "../lmjdata/shaders/polyline.geom"));
    program->addShader(osg::Shader::readShaderFile(osg::Shader::FRAGMENT, "../lmjdata/shaders/polyline.frag"));
